 ...
 * Time: 7:35 PM
 */
function jaControlStructures () {
    
}

$control_structures_code = <<<'CONTROL_STRUCTURES_CODE'

CONTROL_STRUCTURES_CODE;

$control_structures_output = jaControlStructures();

return <<<CONTROL_STRUCTURES_CONTENT
