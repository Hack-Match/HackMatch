...
function ja_regex_engine_intermediate() {

}

$regex_engine_intermediate_code = <<<'regex_engine_intermediate'

regex_engine_intermediate;

$regex_engine_intermediate_output = ja_regex_engine_intermediate();
