...
function ja_regex_engine_advanced() {

}

$regex_engine_advanced_code = <<<'regex_engine_advanced'

regex_engine_advanced;

$regex_engine_advanced_output = ja_regex_engine_advanced();
